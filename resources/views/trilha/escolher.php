...
$folhaTres = $siteRoot . '/imgs/pag3.png';
$folhaQuatro = $siteRoot . '/imgs/pag4.png';
$folhaCinco = $siteRoot . '/imgs/pag5.png';
$folhaSeis = $siteRoot . '/imgs/pag6.png';
...
$trilhas = [
    ['id' => 'potenciacao', 'titulo' => 'Potenciação', 'icone' => '<span class="math-power">x<sup>2</sup></span>', 'descricao' => 'Domine bases, expoentes e propriedades das potências.', 'cor' => 'cyan'],
    ['id' => 'fracoes-algebricas', 'titulo' => 'Frações algébricas', 'icone' => '<span class="math-fraction"><span>x</span><i></i><span>y</span></span>', 'descricao' => 'Simplifique, multiplique e some expressões algébricas.', 'cor' => 'blue'],
    ['id' => 'produtos-notaveis', 'titulo' => 'Produtos notáveis', 'icone' => '<span class="math-power math-product">(a+b)<sup>2</sup></span>', 'descricao' => 'Reconheça padrões e desenvolva expressões com segurança.', 'cor' => 'sky'],
    ['id' => 'fatoracao', 'titulo' => 'Fatoração', 'icone' => '<span class="math-factor">(x-a)<br>(x+a)</span>', 'descricao' => 'Encontre fatores comuns e decomponha expressões.', 'cor' => 'cyan'],
...
<head>
    ...
    <style>
        body.trail-choice-page { background: #02050a url("<?= htmlspecialchars($backgroundDois, ENT_QUOTES, 'UTF-8') ?>") center top / cover fixed !important; }
        ...
        .choice-floating-pages{position:fixed;inset:0;z-index:0;overflow:hidden;pointer-events:none}.choice-floating-pages img{position:absolute;height:auto;opacity:.32;mix-blend-mode:screen;filter:saturate(.9) drop-shadow(0 0 20px rgba(107,152,255,.22));user-select:none}.choice-page-one{top:13%;left:2vw;width:min(240px,17vw);transform:rotate(-9deg);animation:choice-page-one 18s ease-in-out infinite alternate}.choice-page-two{top:17%;right:2vw;width:min(225px,16vw);opacity:.36!important;transform:rotate(7deg);animation:choice-page-two 21s ease-in-out infinite alternate}.choice-page-three{bottom:4%;left:3vw;width:min(190px,14vw);transform:rotate(6deg);animation:choice-page-three 19s ease-in-out infinite alternate}.choice-page-four{bottom:6%;right:3vw;width:min(185px,13vw);opacity:.29!important;transform:rotate(-7deg);animation:choice-page-four 20s ease-in-out infinite alternate}@keyframes choice-page-one{to{transform:translate(20px,-18px) rotate(-4deg)}}@keyframes choice-page-two{to{transform:translate(-22px,18px) rotate(3deg)}}@keyframes choice-page-three{to{transform:translate(18px,-20px) rotate(11deg)}}@keyframes choice-page-four{to{transform:translate(-17px,-16px) rotate(-2deg)}}
        .trail-icon{overflow:hidden;box-sizing:border-box;line-height:1;text-align:center}.trail-icon .math-power{display:inline-flex;align-items:flex-start;white-space:nowrap;line-height:1}.trail-icon .math-power sup{position:relative;top:-.42em;margin-left:.04em;font-size:.53em;line-height:1}.trail-icon .math-product{font-size:.7em;letter-spacing:-.08em}.trail-icon .math-fraction{display:grid;width:1.08em;place-items:center;grid-template-rows:1fr 2px 1fr;font-size:1em;line-height:.8}.trail-icon .math-fraction>span{display:block;font-size:.69em;line-height:1}.trail-icon .math-fraction i{display:block;width:.9em;height:2px;border-radius:99px;background:currentColor;box-shadow:0 0 5px currentColor}.trail-icon .math-factor{font-size:.59em;line-height:1.05;letter-spacing:-.04em;white-space:nowrap}.trail-open b{display:flex;align-items:center;justify-content:center;box-sizing:border-box;padding:0;line-height:1;text-align:center}.trail-open b span{display:block;line-height:1;transform:translate(1px,-1px)}body.trail-choice-page .choice-floating-pages img{position:fixed}@media(max-width:850px){.choice-page-one,.choice-page-two{width:min(155px,20vw)}.choice-page-three,.choice-page-four{width:min(130px,17vw)}}@media(max-width:560px){.choice-floating-pages img{opacity:.18!important}.choice-page-one,.choice-page-four{display:none}.choice-page-two{top:28%;right:-7vw;width:170px}.choice-page-three{bottom:5%;left:-10vw;width:150px}}
    </style>
</head>
<body class="trail-choice-page">
    <?php $navbarActive = 'trilhas'; require APP_ROOT . '/resources/views/layouts/navbar.php'; ?>
    <div class="choice-floating-pages" aria-hidden="true">
        <img class="choice-page-one" src="<?= htmlspecialchars($folhaTres, ENT_QUOTES, 'UTF-8') ?>" alt="">
        <img class="choice-page-two" src="<?= htmlspecialchars($folhaQuatro, ENT_QUOTES, 'UTF-8') ?>" alt="">
        <img class="choice-page-three" src="<?= htmlspecialchars($folhaCinco, ENT_QUOTES, 'UTF-8') ?>" alt="">
        <img class="choice-page-four" src="<?= htmlspecialchars($folhaSeis, ENT_QUOTES, 'UTF-8') ?>" alt="">
    </div>
